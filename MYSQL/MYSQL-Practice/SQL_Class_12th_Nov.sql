...
insert into student_marks values(4,'Nikil',65);
insert into student_marks values(5,'Rohit',86);
insert into student_marks values(6,'Deepak',77);


-- write a query to calculate the grades for a student by following below criteria
--marks >= 90, grade A+
...
SELECT * FROM employees_full_data WHERE (emp_id IN (SELECT mgr_id FROM employees_full_data));
