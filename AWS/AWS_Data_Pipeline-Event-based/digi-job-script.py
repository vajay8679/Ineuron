...
AmazonS3_node1681042111163 = glueContext.create_dynamic_frame.from_options(
    format_options={},
    connection_type="s3",
    format="parquet",
    connection_options={"paths": ["s3://project-digi/raw_data/"], "recurse": True},
    transformation_ctx="AmazonS3_node1681042111163",
)

# Script generated for node Select Fields
SelectFields_node1681042172413 = SelectFields.apply(
    frame=AmazonS3_node1681042111163,
    paths=["name", "id"],
...
AmazonS3_node1681042307291 = glueContext.write_dynamic_frame.from_options(
    ...
    connection_type="s3",
    format="parquet",
    connection_options={"path": "s3://project-digi/cureated_data/", "partitionKeys": []},
