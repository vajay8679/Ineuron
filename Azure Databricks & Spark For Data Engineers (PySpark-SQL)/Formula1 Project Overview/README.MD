...
file - Formula1 Project Overview/ingestion/3.ingest_constructor_file.ipynb
...
file - Formula1 Project Overview/ingestion/4.ingest_driver_file.ipynb
...
file - Formula1 Project Overview/ingestion/5.ingest_result_file.ipynb
...
file - Formula1 Project Overview/ingestion/6.ingest_pit_stops_file.ipynb
...
file - Formula1 Project Overview/ingestion/7.ingest_lap_times_file.ipynb
...
file - Formula1 Project Overview/ingestion/8.ingest_qualifying_file.ipynb
...
File - Formula1 Project Overview/ingestion_with_includes/1.ingest_circuits_file.ipynb
File - Formula1 Project Overview/includes/common_functions.ipynb
...
file - Formula1 Project Overview/demo/1.filter_demo.ipynb
...
file - Formula1 Project Overview/demo/2.join_demo.ipynb
...
File - Formula1 Project Overview/trans/1.race_results.ipynb
...
92. Simple Aggregate functions
 ...
 file - Formula1 Project Overview/demo/3.aggregation_demo.ipynb
...
file - Formula1 Project Overview/trans/2.driver_standings.ipynb
...
file - Formula1 Project Overview/trans/3.constructor_standings.ipynb
...
file - Formula1 Project Overview/demo/4.sql_temp_view_demo.ipynb
...
file - Formula1 Project Overview/demo/6.sql_objects_demo.sql
...
file name - Formula1 Project Overview/raw/1.create_raw_tables.sql
...
File - Formula1 Project Overview/demo/7.sql_basic_demo
...
file - Formula1 Project Overview/demo/9.sql_joins_demo
...
file - Formula1 Project Overview/trans/4.calculated_race_result
...
file - Formula1 Project Overview/analysis/1.find_dominant_drivers - file
...
File - Formula1 Project Overview/analysis/2.find_dominant_teams
...
File - Formula1 Project Overview/analysis/3.viz_dominant_drivers
...
File - Formula1 Project Overview/analysis/4.viz_dominant_teams
...
Scenario1 -.use full data in day1 and then incremental data from day two that is not good

scenario2 -> use incremental data from day one that will be better
