...
kafka_topic_name varchar(50),
last_sent_id varchar(100),
exported_timestamp datetime);

ALTER TABLE export_management
MODIFY COLUMN exp_id int NOT NULL AUTO_INCREMENT;



ALTER TABLE products
add column productCreatedTimestamp timestamp DEFAULT CURRENT_TIMESTAMP;


ALTER TABLE productlines
add column productlinesCreatedTimestamp timestamp DEFAULT CURRENT_TIMESTAMP;
